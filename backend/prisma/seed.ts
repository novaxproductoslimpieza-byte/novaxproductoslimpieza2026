...
async function main() {
  ...
  // ── 6. DEMO CLIENTES (10 REGISTROS) ──
  console.log('👥 Creando clientes de demo...');
  const demoClients = [
    { nombre: 'Ana García', ci: '1001', lat: -17.360, lng: -66.155, zona: 'Zona Norte' },
    { nombre: 'Carlos Ruiz', ci: '1002', lat: -17.375, lng: -66.162, zona: 'Zona Centro' },
    { nombre: 'María Lopez', ci: '1003', lat: -17.395, lng: -66.148, zona: 'Zona Sur' },
    { nombre: 'Pedro Ortiz', ci: '1004', lat: -17.368, lng: -66.170, zona: 'Calacala' },
    { nombre: 'Elena Sosa', ci: '1005', lat: -17.382, lng: -66.151, zona: 'Sarco' },
    { nombre: 'Luis Duran', ci: '1006', lat: -17.362, lng: -66.142, zona: 'Queru Queru' },
    { nombre: 'Sofía Vaca', ci: '1007', lat: -17.370, lng: -66.158, zona: 'Zona Norte' },
    { nombre: 'Hugo Mendez', ci: '1008', lat: -17.388, lng: -66.165, zona: 'Zona Centro' },
    { nombre: 'Rosa Salgueiro', ci: '1009', lat: -17.392, lng: -66.155, zona: 'Zona Sur' },
    { nombre: 'Oscar Vargas', ci: '1010', lat: -17.365, lng: -66.160, zona: 'Calacala' },
  ];

  for (const demo of demoClients) {
    const zona = await prisma.zona.findFirst({ where: { nombre: demo.zona } });
    await prisma.usuario.upsert({
      where: { correo: `demo${demo.ci}@novax.com` },
      update: {},
      create: {
        nombre: demo.nombre,
        ci: demo.ci,
        telefono: `7000${demo.ci}`,
        direccion: `Dirección Demo ${demo.nombre}`,
        correo: `demo${demo.ci}@novax.com`,
        password: clientPassword,
        rol: 'CLIENTE',
        latitud: demo.lat,
        longitud: demo.lng,
  ...
  console.log('✅ 10 Clientes de demo creados');
