    ...
    Promise.all([
      ...
      .then(([products, orders, clients]) => {
        setStats({
          ...
          pendingOrders: orders.filter((o: any) => o.estado === "PENDIENTE")
            .length,
        });
    ...
    <div>
      <div className="py-2">
        <div className="row mb-4">
          <div className="col">
            <h1 className="h2 fw-bold text-dark mb-1 window-title">
              Dashboard
            </h1>
          ...
          {loading
            ...
            : statCards.map((s) => (
                <div key={s.label} className="col-6 col-md-3">
                  <Link
                    href={s.link}
                    className="window-card h-100 p-3 text-decoration-none transition-scale product-card-hover"
          ...
          <div className="col">
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              <Link
                ...
                className="btn btn-outline-primary-dark btn-sm rounded-pill px-3 fw-bold"
              >
                Ver todos
              </Link>
            </div>
                      ...
                      recentOrders.map((o) => (
                        <tr key={o.id}>
                          ...
                          <td className="text-muted small">
                            {new Date(o.fecha).toLocaleDateString("es-BO")}
                          </td>
                          <td>
                            <span
                              className={`badge rounded-pill bg-opacity-10 py-1 px-2 small bg-${o.estado === "PENDIENTE" ? "warning text-warning" : o.estado === "APROBADO" ? "primary text-primary" : o.estado === "ENTREGADO" ? "success text-success" : "info text-info"}`}
                            >
                              {o.estado}
                            </span>
                          </td>
                          <td className="pe-4 text-end">
                            <Link
                              href="/admin/orders"
                              className="btn btn-light btn-sm rounded-pill px-3 border border-light fw-bold text-dark"
                            >
                              Ver detalles
                            </Link>
                          </td>
