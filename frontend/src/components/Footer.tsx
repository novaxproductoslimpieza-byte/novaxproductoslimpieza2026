...
const Footer: React.FC = () => {
  return (
    <footer className="footer py-5 mt-auto text-light" style={{ background: '#0a0f1d' }}>
      <div className="container">
        <div className="row g-4">
          <div className="col-lg-4">
            <div className="d-flex align-items-center gap-2 mb-3">
              <img src="/logonovax.png" alt="Logo" height="35" className="rounded-1" />
          ...
          <div className="col-lg-3">
            ...
            <ul className="list-unstyled small d-flex flex-column gap-2">
              <li className="text-white-50 d-flex gap-2">
                <span>📍</span> San Miguel, Santa Cruz, Bolivia
              </li>
              <li className="text-white-50 d-flex gap-2">
                <span>📞</span> +591 700 00000
              </li>
              <li className="text-white-50 d-flex gap-2">
                <span>✉️</span> ventas@novax.com.bo
              </li>
            </ul>
          </div>
        </div>
